...
?>
	 ...
	 */
	function render_panel_header( $label, $priority, $control_name, $description, $panel ) {
		global $wp_customize;
		if ( isset( $label ) ) {
	 ...
	 * Render section head
	 */
	function render_section_header( $label, $priority, $control_name, $description, $panel ) {
		global $wp_customize;
		if ( isset( $label ) ) {
			if ( !isset( $control_name ) ) {
				$control_name = strtolower( $label );
...
*/
	...
	*/
	...
	render_panel_header ( 'Notification panel', 40, 'lbmn_panel_notificationpanel', 'Site-wide notification panel settings');
		...
		render_checkbox_control ( 'Enable', 'lbmn_notificationpanel_basic', 20, 1, 'lbmn_notificationpanel_switch' ); // Notification panel switch
		...
		render_textarea_control ( 'Message', 'lbmn_notificationpanel_elements', 30, LBMN_NOTIFICATIONPANEL_MESSAGE_DEFAULT, 'lbmn_notificationpanel_message' ); // Notification message
		render_text_control ( 'Linked URL', 'lbmn_notificationpanel_elements', 40, LBMN_NOTIFICATIONPANEL_BUTTONURL_DEFAULT, 'lbmn_notificationpanel_buttonurl' );// Call to action button url

		// Colors
		render_section_header ( 'Colors', 60, 'lbmn_notificationpanel_colors', '', 'lbmn_panel_notificationpanel');
		render_colorpickersliders_control ( 'Background Color', 'lbmn_notificationpanel_colors', 200, LBMN_NOTIFICATIONPANEL_BACKGROUNDCOLOR_DEFAULT, 'lbmn_notificationpanel_backgroundcolor' ); // Top panel bg color
		render_colorpickersliders_control ( 'Text Color', 'lbmn_notificationpanel_colors', 300, LBMN_NOTIFICATIONPANEL_TXTCOLOR_DEFAULT, 'lbmn_notificationpanel_textcolor' ); // Top panel text color
	...
	render_panel_header ( 'Top bar', 50, 'lbmn_panel_topbar', 'Site-wide top panel settings');
		...
		render_checkbox_control ( 'Enable', 'lbmn_topbar_basic', 20, 1, 'lbmn_topbar_switch' ); // Top panel switch
		...
		render_live_select_control ( 'Font Weight', 'lbmn_topbar_font', 330, 'lbmn_topbar_firstlevelitems_fontweight', $font_weight_options, LBMN_TOPBAR_FIRSTLEVELITEMS_FONTWEIGHT_DEFAULT ); //$font_weight_options // get_theme_mod( 'lbmn_headertop_firstlevelitems_font')
	...
	render_image_control ( 'Normal Image', 'lbmn_logo_basic', 30, 'lbmn_logo_image', LBMN_LOGO_IMAGE_DEFAULT ); //$default_image - optional parameter
	...
	render_live_select_control ( 'Font Weight', 'lbmn_megamenu_font', 320, 'lbmn_megamenu_firstlevelitems_fontweight', $font_weight_options, LBMN_MEGAMENU_FIRSTLEVELITEMS_FONTWEIGHT_DEFAULT ); //$font_weight_options // get_theme_mod( 'lbmn_headertop_firstlevelitems_font')
...
*/
	...
	*/
	...
	render_section_header ( 'System Page Templates', 700, 'lbmn_more', '' );
...
function lbmn_add_customizer_js() {
	...
	wp_enqueue_script( 'lbmn_customizer_adminjs', get_template_directory_uri() . '/inc/customizer/customizer-admin.js', array( 'jquery' ), '20141228-15', true ); //  array( 'jquery', 'iris', 'wp-color-picker' )
