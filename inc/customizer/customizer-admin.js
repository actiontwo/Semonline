...
$(document).ready(function() {
	...
	*/
	...
	function grouped_controls(elementsToGroup, groupClass, title, helptext) {
		...
		$(elementsToGroup).wrapAll('<li class="grouped-controls postbox '+groupClass+'"><ul class="inside"></ul></li>');
	...
	$('.control-panel > .accordion-section-title').live('click', function(event) {
		$(this).parent().find('.control-panel-content .control-subsection').first().addClass('open');
	});

/*
	$('#accordion-section-lbmn_notificationpanel').live('click', function(event) {
		console.info( 'click' );
...
/*
	...
	*/
	...
	if ( customizerDataSentOnLoad.notInstalled_requiredPlugin ) {
	...
	*/
	if ( customizerDataSentOnLoad.notInstalled_MegaMainMenu ) {
